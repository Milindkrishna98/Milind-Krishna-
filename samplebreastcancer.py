...
#M-mallignant(cancer cell)- 1 -----  B-binyne(no cancer cell)- 0
...
print(df.iloc[:,1:12].corr())#Get a sample of correlated column info

#Visualize the correlation graph 3
...
#Classification accuracy is the ratio of correct predictions to total predictions made.---------process 1
...
#Show other ways to get the classification accuracy & other metrics.-----------process 2
